...
function setupGame(level) {
  ...
  // Generate random patterns for each level
...
function showLifeLost() {
  ...
  lifeMsg.style.color = "rgba(255,0,0,0.7)";
  lifeMsg.style.fontWeight = "bold";
  lifeMsg.style.pointerEvents = "none";
  document.body.appendChild(lifeMsg);

  setTimeout(() => lifeMsg.remove(), 1000);
}
